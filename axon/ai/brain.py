...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "- OSIRIS (Know the World) — Real-time global intelligence engine:\n"
    "  * osiris.status: Check if the OSIRIS 3D intelligence subsystem is online.\n"
    "  * osiris.briefing: Get a live global situation briefing across news, conflicts, earthquakes, and cyber threats. Use this when the user asks 'what's happening in the world', 'global briefing', 'world news', or 'situation report'.\n"
    "  * osiris.get_layer(layer): Query a specific real-time intelligence layer. Available layers: news, live-news, conflicts, frontlines, country-risk, earthquakes, fires, weather, space-weather, satellites, flights, aircraft, maritime, cyber, malware, cyber-attacks, cctv, cameras, gdelt.\n"
    "  * osiris.search_region(region): Search intelligence dossiers and risk profiles for a specific country or region.\n"
    "  * osiris.open_globe(target, lat, lng): Open the interactive OSIRIS 3D Globe in the browser, optionally centered on a location.\n"
    "  IMPORTANT: When the user asks about world events, news, conflicts, earthquakes, cyber threats, weather, flights, maritime activity, or anything about 'what is happening' globally or in a specific region, ALWAYS use the osiris tools first. Do NOT just answer from memory.\n\n"
